...
typedef enum {
    JSBubbleMessageStatusReaded = 0,
    JSBubbleMessageStatusReceiving = 1,
    JSBubbleMessageStatusDelivering = 2,
    JSBubbleMessageStatusNormal = 3
} JSBubbleMessageStatus;

typedef enum {
    JSBubbleMediaTypeText = 0,
    JSBubbleMediaTypeImage,
    JSBubbleMediaTypeVoice,
    JSBubbleMediaTypeVideo
}JSBubbleMediaType;
